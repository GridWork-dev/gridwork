...
{/* curated-from: docs/PARITY.md sha256=f2d684c8b0eb0916c3850d7ebdf18ed3859037d4d2176a7f1c3e80c7815453a7 */}
...
protocol onto the `LifecycleFact` and `EngineStatus` vocabularies this page
...
and conflating them would make this row pass on a fact nothing observed.
