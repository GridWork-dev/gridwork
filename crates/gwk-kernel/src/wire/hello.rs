...
use gwk_domain::protocol::{
    ...
    KernelErrorCode, MAX_CAPABILITIES, PROTOCOL_MINOR, PTY_CONTROL_CAPABILITY,
    PTY_INPUT_CAPABILITY, PTY_RAW_CAPABILITY, PTY_START_CAPABILITY, ProtocolVersion, ServerControl,
};
